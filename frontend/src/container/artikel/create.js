            ...
            <div className="background p-10">
                ...
                <form className="rounded p-10" onSubmit={this.handlerSubmit}>
                    ...
                    <div className="mb-6">
                        ...
                        <input className="shadow appearance-none border rounded-full w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="createdAt" type="date" placeholder="createdAt" value={this.state.createdAt} onChange = {this.handlerChange} required/>
                    </div>
                    <div className="mb-6">
                        <label className="block text-sm font-header mb-2 uppercase" for="updatedAt">updatedAt</label>
                        <input className="shadow appearance-none border rounded-full w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="updatedAt" type="date" placeholder="updatedAt" value={this.state.updatedAt} onChange = {this.handlerChange} required/>
                    </div>
                    <input 
                        type = 'submit'
                        value = 'submit'
